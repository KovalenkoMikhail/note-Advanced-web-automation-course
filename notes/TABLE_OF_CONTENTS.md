# IT Lecture Notes - Table of Contents

**Complete IT Lecture Notes - Organized by Theme**

This comprehensive guide covers networking, testing, DevOps, databases, and programming fundamentals with 38 sections organized into 5 thematic categories.
...
**What You'll Learn:**
- DNS caching and record types (A, AAAA, CNAME, MX, NS)
- TCP vs UDP protocols and use cases
- HTTP/1 vs HTTP/2 vs HTTP/3 comparison
- QUIC protocol advantages
- OSI 7-layer model
- SSH secure connections and tunneling
...
**What You'll Learn:**
- Software testing lifecycle and principles
- Test case and bug report structure
- Test design techniques (boundary analysis, pairwise testing, decision tables)
- 10 QA Commandments
...
- Advanced Git (bisect, cherry-pick, reflog)
- Git hooks and tags
...
- UUID vs ULID identifiers
- Dead Letter Queue (DLQ)
- RabbitMQ message broker
- REST API design principles
- JWT and OAuth 2 authentication
- Telegram Bot API
...
**What You'll Learn:**
- Java ProcessBuilder and error handling
- Browser storage (Cookies, LocalStorage, SessionStorage)
- Linux command line essentials
- HTML structure and elements
- JavaScript functions (closures, arrow functions)
- JavaScript iteration methods (forEach, for...in, for...of)
...
Quick-reference glossary with:
- **250+ technical terms** - Alphabetically organized
- **Git commands** - Complete command reference
- **Linux commands** - Essential CLI operations
...
- **Total Sections:** 38
- **Total Pages:** 5 thematic documents
- **Topics Covered:** 100+
- **Code Examples:** 50+
- **Technical Terms:** 250+
- **Commands Referenced:** 100+

---

## 🚀 How to Use This Guide

1. **By Role:** Choose your learning path based on your role (QA, Backend, DevOps, Full-Stack)
2. **By Topic:** Use the topic search to find specific subjects
3. **Sequential:** Read all 5 documents in order for comprehensive knowledge
4. **Reference:** Use the Glossary for quick term lookups

---

**Last Updated:** December 16, 2025  
**Branch:** theme-based-reorganization  
**Status:** Complete reorganization with thematic structure
